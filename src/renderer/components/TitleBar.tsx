  ...
  return (
    <header className="titlebar">
      ...
      <div className="titlebar-controls">
        <button className="titlebar-btn titlebar-btn--min" onClick={() => api.windowMinimize?.()} aria-label={t('common.minimize')}>
          <svg width="12" height="12" viewBox="0 0 12 12"><rect x="2" y="5.5" width="8" height="1" fill="currentColor" /></svg>
        </button>
        <button className="titlebar-btn titlebar-btn--max" onClick={() => api.windowMaximize?.()} aria-label={t('common.maximize')}>
        ...
        <button className="titlebar-btn titlebar-btn--close" onClick={() => api.windowClose?.()} aria-label={t('common.close')}>
